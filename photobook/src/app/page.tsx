    ...
    <div className="min-h-screen overflow-x-hidden" style={{ backgroundColor: COLOR.surface, color: COLOR.onSurface }}>
      ...
      <section style={{ padding: '80px 0', backgroundColor: COLOR.surfaceContainerLow }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
          ...
          {/* 4 Hero Theme Cards in a single row on desktop so all fit in one page view */}
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[13px] lg:text-[14px] line-clamp-1" style={{ fontFamily: 'var(--font-hanken)', color: COLOR.onSurfaceVariant }}>
