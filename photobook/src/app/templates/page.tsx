...
export default function TemplatesPage() {
  ...
  return (
    <div style={{ minHeight: '100svh', backgroundColor: '#fff8f0', color: '#1d1b17' }}>
      <Navbar />

      <main style={{ maxWidth: 1280, margin: '0 auto', padding: '64px 24px 96px', width: '100%', minHeight: 'calc(100svh - 80px)' }}>
